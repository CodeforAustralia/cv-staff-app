...
function deleteAccessRequest (cb, data) {
  ...
  xmlHttp.open('POST', `http://ec2-54-66-246-123.ap-southeast-2.compute.amazonaws.com/brian/src/public/staff/delete`, true)
  xmlHttp.withCredentials = true
  xmlHttp.setRequestHeader('Authorization', `Basic ${process.env.API}`)
  xmlHttp.setRequestHeader('Accept', 'application/json')
  xmlHttp.setRequestHeader('Content-Type', 'application/json')
...
function grantAccess (cb, data) {
  ...
  xmlHttp.open('POST', `http://ec2-54-66-246-123.ap-southeast-2.compute.amazonaws.com/brian/src/public/staff/authenticate`, true)
  xmlHttp.withCredentials = true
  xmlHttp.setRequestHeader('Authorization', `Basic ${process.env.API}`)
  xmlHttp.setRequestHeader('Accept', 'application/json')
  xmlHttp.setRequestHeader('Content-Type', 'application/json')
...
function findSalt (cb, data) {
  ...
  xmlHttp.open('GET', `http://ec2-54-66-246-123.ap-southeast-2.compute.amazonaws.com/brian/src/public/user/salt/${data.Username}`, true)
  xmlHttp.withCredentials = true
  xmlHttp.setRequestHeader('Authorization', `Basic ${process.env.API}`)
  xmlHttp.setRequestHeader('Accept', 'application/json')
  xmlHttp.setRequestHeader('Content-Type', 'application/json')
