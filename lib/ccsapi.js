...
function getLocations (cb) {
  var req = GETRequest(`http://ec2-54-66-246-123.ap-southeast-2.compute.amazonaws.com/brian/src/public/location`)
...
function getRegionData (cb, data) {
  var req = GETRequest(`http://ec2-54-66-246-123.ap-southeast-2.compute.amazonaws.com/brian/src/public/region/${data.regionID}`)
