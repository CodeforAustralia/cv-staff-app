...
module.exports = function (state, emit) {
  ...
  var template = state.selected.appointmentType ? state.static.templates['Reminder'][state.selected.appointmentType] : state.static.templates['Reminder'][state.static.appointmentTypes[0]]
  return html`
